...
//      }
    ...
    GroundManager.prototype.replaceItem = function(cellIndex, type, play, toCellIndex, itemLength){
        ...
        if(!play || (play && this.ground[i][j] == 1)){
            ...
            this.addItem(type, i, j, itemLength);
    ...
    GroundManager.prototype.doMerge = function(){
        ...
        var count = 0, type = -1;
        var mLength = this.toMerge.length;
        for(var i = 0; i < mLength; i++){
            ...
            this.replaceItem(cellIndex, type+1, false, null);
...
//          this.groundMerge(cellIndex);
    ...
    GroundManager.prototype.listen = function(targetPoint){
        var cellIndex = this.getGroundByPoint(targetPoint);
        if(this.checkCellIndex(cellIndex)){
            var cur = this.ground[cellIndex.i][cellIndex.j];
            if(cur == 1){
